...
(function() {
  ...
  WebGL = (function() {
    function WebGL(gl, shaderProgram, triangleVertexPositionBuffer, squareVertexPositionBuffer, mvMatrix, pMatrix) {
      this.gl = gl;
      ...
      this.mvMatrix = mvMatrix != null ? mvMatrix : mat4.create();
      this.pMatrix = pMatrix != null ? pMatrix : mat4.create();
    }
